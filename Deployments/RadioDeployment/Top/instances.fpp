module RadioDeployment {
  ...
  instance transceiverConfigManager: Components.TransceiverConfigurationManager base id 0x10005000 \
    queue size Default.QUEUE_SIZE \
    stack size Default.STACK_SIZE \
    priority 100

  instance transceiverCommsManager: Components.TransceiverCommsManager base id 0x10016000 \
    queue size Default.QUEUE_SIZE \
    stack size Default.STACK_SIZE \
    priority 99
  ...
  instance i2cLinuxDriver: Drv.LinuxI2cDriver base id 0x10000010
